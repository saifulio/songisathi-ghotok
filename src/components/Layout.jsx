...
function canSee(item, user) {
  ...
  if (item.hideWhenSelfManaged && user.selfManaged) return false;
  return true;
}
    ...
    <div className="ss-shell">
      <header className="ss-topbar">
        <div className="ss-topbar-inner">
          ...
          {/* Outside the nav on purpose: the nav scrolls sideways once the
              links outgrow the bar, and log out used to scroll away with them.
              Pinned here it stays reachable at any width. */}
